...
public class TimeFrameTest {
    ...
    public void testIsDerivableFrom() {
        ...
        tf1 = new TimeFrame(new Period(PeriodType.SECOND, 1), dt1, null);
        
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.ONE_MINUTE, dt2, null);
        
        assertTrue(tf2.isDerivableFrom(tf1));
        assertFalse(tf1.isDerivableFrom(tf2));
        
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(new Period(PeriodType.MINUTE, 1), dt1, null);
        
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.ONE_HOUR, dt2, null);
        
        assertTrue(tf2.isDerivableFrom(tf1));
        assertFalse(tf1.isDerivableFrom(tf2));
        
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(Period.ONE_HOUR, dt1, null);
        
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.DAY, dt2, null);
        
        assertTrue(tf2.isDerivableFrom(tf1));
        assertFalse(tf1.isDerivableFrom(tf2));
        
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(Period.DAY, dt1, null);
        
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.WEEK, dt2, null);
        ...
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(Period.WEEK, dt1, null);
        
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.MONTH, dt2, null);
        
        assertFalse(tf2.isDerivableFrom(tf1));
        assertFalse(tf1.isDerivableFrom(tf2));
        
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(Period.MONTH, dt1, null);
        
        //Pattern returns as viable her
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.QUARTER, dt2, null);
        
        assertTrue(tf2.isDerivableFrom(tf1));
        assertFalse(tf1.isDerivableFrom(tf2));
        
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(Period.QUARTER, dt1, null);
        
        //Pattern returns as viable her
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(Period.YEAR, dt2, null);
        ...
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(Period.ONE_MINUTE, dt1, null);
        
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(new Period(PeriodType.MINUTE, 5), dt2, null);
        
        assertTrue(tf2.isDerivableFrom(tf1));
        
        //5Min !Derivable from 5Min
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(new Period(PeriodType.MINUTE, 5), dt1, null);
        ...
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(new Period(PeriodType.MINUTE, 10), dt2, null);
        ...
        dt2 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf2 = new TimeFrame(new Period(PeriodType.MINUTE, 10), dt2, new DateTime(2013, 12, 30, 12, 0, 0));
        
        assertTrue(tf2.isDerivableFrom(tf1));
        
        //First having end date while 2nd not having end date causes failure
        dt1 = new DateTime(2013, 12, 10, 12, 0, 0);
        tf1 = new TimeFrame(new Period(PeriodType.MINUTE, 1), dt1, new DateTime(2013, 12, 30, 12, 0, 0));
