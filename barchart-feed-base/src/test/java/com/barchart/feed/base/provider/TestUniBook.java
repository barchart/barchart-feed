...
public class TestUniBook {
	...
	public void testNullEntryAddDelete() {
		...
		final UniBook book = new UniBook(BookLiquidity.COMBINED, size, priceStep);
	...
	public void testWrongEnums() {
		...
		final UniBook book = new UniBook(BookLiquidity.COMBINED, size, step);
		DefBookEntry entry;
		UniBookResult result;

		entry = new DefBookEntry(NOOP, GAP, BookLiquidity.NONE, 0, newPrice(1000, -2),
				NULL_SIZE);
		result = book.make(entry);
		assertEquals(result, ERROR);

		entry = new DefBookEntry(MODIFY, GAP, BookLiquidity.NONE, 0, newPrice(1000, -2),
				NULL_SIZE);
		result = book.make(entry);
		assertEquals(result, ERROR);

		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.NONE, 0, newPrice(1000, -2),
				NULL_SIZE);
		result = book.make(entry);
		assertEquals(result, ERROR);

		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, 0, newPrice(1000, -2),
				NULL_SIZE);
		result = book.make(entry);
	...
	public void testJavaSize2() {
		final SizeValue size = newSize(10);
		final PriceValue step = newPrice(25, -2);
		final UniBook book = new UniBook(BookLiquidity.DEFAULT, size, step);
		final int bookSize = JavaSize.of(book);
	...
	public void testJavaSize3() {
		final SizeValue size = newSize(10);
		final PriceValue step = newPrice(25, -2);
		final UniBook book = new UniBook(BookLiquidity.NONE, size, step);
		final int bookSize = JavaSize.of(book);
	...
	public void testBasicAddDelete() {
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 1, newPrice(1100, -2),
				newSize(17));
		result = book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, 0, newPrice(900, -2),
				newSize(9));
		result = book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 0, newPrice(1200, -2),
				newSize(21));
		result = book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(REMOVE, ASK, BookLiquidity.DEFAULT, 2, null, null);
		result = book.make(entry);
		// System.out.println(book);
		entry = asks.get(newPrice(1200, -2));
		assertEquals(result, NORMAL);
		...
		entry = new DefBookEntry(REMOVE, BID, BookLiquidity.DEFAULT, 1, null, null);
		result = book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(REMOVE, ASK, BookLiquidity.DEFAULT, 1, null, null);
		result = book.make(entry);
		// System.out.println(book);
	...
	public void testCountPlaces() {
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 1, newPrice(1000, -2),
				newSize(13));
		book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 0, newPrice(1100, -2),
				newSize(17));
		book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 1, newPrice(1050, -2),
				newSize(19));
		book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 0, newPrice(1425, -2),
				newSize(21));
		book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 0, newPrice(1400, -2),
				newSize(23));
		book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 1, newPrice(1275, -2),
				newSize(25));
		book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, 1, newPrice(3275, -2),
				newSize(11));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, TOP);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, 9, newPrice(3150, -2),
				newSize(13));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, NORMAL);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, -1, newPrice(3350, -2),
				newSize(15));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, TOP);
		...
		entry = new DefBookEntry(REMOVE, BID, BookLiquidity.DEFAULT, 1, NULL_PRICE, null);
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, TOP);
		...
		assertEquals(entry.type(), BookLiquidity.COMBINED);
		assertEquals(entry.place(), 1);
	...
	public void testComboMerge() {
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, -1, newPrice(3300, -2),
				newSize(13));
		result = book.make(entry);
		// System.out.println(book);
		entry = book.topFor(ASK);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.IMPLIED, -1, newPrice(3275, -2),
				newSize(15));
		result = book.make(entry);
		// System.out.println(book);
		entry = book.topFor(BID);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.IMPLIED, -1, newPrice(3300, -2),
				newSize(17));
		result = book.make(entry);
		// System.out.println(book);
		entry = book.topFor(ASK);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.IMPLIED, -1, newPrice(3200, -2),
				newSize(19));
		result = book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.IMPLIED, -1, newPrice(3400, -2),
				newSize(21));
		result = book.make(entry);
		// System.out.println(book);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.IMPLIED, 1, newPrice(3250, -2),
				newSize(23));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, TOP);

		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.IMPLIED, 1, newPrice(3325, -2),
				newSize(25));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, TOP);
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, 0, newPrice(3200, -2),
				newSize(27));
		result = book.make(entry);
		// System.out.println(book);
		entry = bids.get(newPrice(3200, -2));
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.DEFAULT, 0, newPrice(3325, -2),
				newSize(29));
		result = book.make(entry);
		// System.out.println(book);
	...
	public void testEntries() {
		...
		entry = new DefBookEntry(MODIFY, BID, BookLiquidity.DEFAULT, 0, newPrice(3125, -2),
				newSize(29));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, NORMAL);
		...
		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.IMPLIED, 0, newPrice(3225, -2),
				newSize(31));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, TOP);

		entry = new DefBookEntry(MODIFY, ASK, BookLiquidity.IMPLIED, 0, newPrice(3325, -2),
				newSize(33));
		result = book.make(entry);
		// System.out.println(book);
		assertEquals(result, NORMAL);
		...
		entry = new DefBookEntry(NOOP, BID, BookLiquidity.COMBINED, 2, newPrice(3125, -2),
				newSize(29));
		assertEquals(entry, entriesBid[0]);

		entry = new DefBookEntry(NOOP, BID, BookLiquidity.COMBINED, 1, newPrice(3200, -2),
				newSize(27));
		assertEquals(entry, entriesBid[1]);

		//

		entry = new DefBookEntry(NOOP, ASK, BookLiquidity.COMBINED, 1, newPrice(3225, -2),
				newSize(31));
		assertEquals(entry, entriesAsk[0]);

		entry = new DefBookEntry(NOOP, ASK, BookLiquidity.COMBINED, 2, newPrice(3325, -2),
				newSize(33));
