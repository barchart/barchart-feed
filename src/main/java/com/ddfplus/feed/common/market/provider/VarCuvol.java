...
import com.ddfplus.feed.common.util.collections.PriceArrayMap;

@Mutable
@NotThreadSafe
final class VarCuvol extends NulCuvol implements MarketDoCuvol {

	private final PriceArrayMap<SizeValue> map;

	private PriceValue priceLast;

	VarCuvol(final PriceValue priceStep) {
