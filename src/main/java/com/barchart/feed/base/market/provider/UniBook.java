...
import static com.barchart.feed.base.market.enums.MarketBookSide.*;
import static com.barchart.feed.base.market.enums.MarketBookType.*;
import static com.barchart.feed.base.market.provider.UniBookResult.*;
import static com.barchart.feed.base.market.provider.UniBookRing.*;
import static com.barchart.feed.base.market.values.MarketBook.*;
...
class UniBook<V extends Value<V>> extends ValueFreezer<V> {
	...
	public UniBook(final MarketBookType type, final SizeValue size,
