...
public class DefaultPriceFormat implements PriceFormat {
	...
	public DefaultPriceFormat(final int denominator_, final int precision_, final boolean fractional_) {
		this(denominator_, precision_, fractional_, 0, 0, SubFormat.FLAT);
	}

	public DefaultPriceFormat(final int denominator_, final int precision_, final boolean fractional_,
			final int subDenominator_, final int subPrecision_, final SubFormat subFormat_) {
