...
import static com.barchart.feed.api.framework.data.InstrumentField.BOOK_LIQUIDITY;
import static com.barchart.feed.api.framework.data.InstrumentField.BOOK_STRUCTURE;
import static com.barchart.feed.api.framework.data.InstrumentField.CFI_CODE;
import static com.barchart.feed.api.framework.data.InstrumentField.COMPONENT_LEGS;
...
import static com.barchart.feed.api.framework.data.InstrumentField.MARKET_HOURS;
import static com.barchart.feed.api.framework.data.InstrumentField.POINT_VALUE;
import static com.barchart.feed.api.framework.data.InstrumentField.SECURITY_TYPE;
...
import static com.barchart.feed.api.framework.data.InstrumentField.TIME_ZONE_NAME;
import static com.barchart.feed.api.framework.data.InstrumentField.TIME_ZONE_OFFSET;
