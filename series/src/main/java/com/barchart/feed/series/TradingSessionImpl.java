...
public class TradingSessionImpl implements TradingSession {
     ...
     */
    public TradingSessionImpl(int day, int endDay, LocalTime start, LocalTime end) {
        this.day = day;
        this.endDay = endDay;
        this.start = start;
        this.end = end;
    ...
    public static long sessionMillis(int startDay, LocalTime startTime, int endDay, LocalTime endTime) {
        ...
        if(TradingWeekImpl.naturalDaysBetween(startDay, endDay) > 0) {
            dt2 = dt.millisOfDay().withMaximumValue().plusMillis(1);
            dt2 = dt2.plusMillis((TradingWeekImpl.naturalDaysBetween(startDay, endDay) - 1) * MILLIS_IN_DAY);
	...
	public String dayToString() {
        return TradingWeekImpl.dayToString(day);
    }
    ...
    public int compareTo(TradingSession other) {
    	TradingSessionImpl o = (TradingSessionImpl)other;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TradingSessionImpl other = (TradingSessionImpl) obj;
        if (day != other.day)
            return false;
        if (end == null) {
            if (other.end != null)
