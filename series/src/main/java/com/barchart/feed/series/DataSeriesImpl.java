...
public class DataSeriesImpl<E extends DataPointImpl> implements DataSeries<E> {
	 ...
	 * time and data for every {@link DataPointImpl}.
	 * 
	...
	/**
	 * Returns the {@link DataPointImpl} correlated to the specified time or null.
	 * 
	 * <pre><b>
	 ...
	 * </b></pre>
	 * 
	 * @param 		time	the time for which the returned {@link DataPointImpl} is correlated.
	 * @return		the {@link DataPointImpl} correlated to the specified time or null
	 */
	@SuppressWarnings("unchecked")
	@Override
    ...
    /**
     * Inserts the {@link DataPointImpl} specified into the backing
    ...
    /**
     * Removes the {@link DataPointImpl} at the specified index, and 
