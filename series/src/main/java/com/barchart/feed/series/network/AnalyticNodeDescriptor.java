...
public class AnalyticNodeDescriptor implements AnalyticDescriptor {
    ...
    */
     ...
     *  
     * @param sourceKey     the key the {@link TimeFrameImpl} is mapped to.
    ...
    /**
     * Returns the index of the {@link TimeFrameImpl} identified by "key"
     * in the order it is declared.
     * 
     * @param tf      the identifier which corresponds with the {@link TimeFrameImpl}
     ...
     * that each {@link TimeFrameImpl} will resolve to given the place holder key that data
