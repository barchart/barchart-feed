 ...
 * TradingWeeks contain {@link TradingSessionImpl}s which in turn define the hours
 ...
 * @author David Ray
 */
public class TradingWeekImpl extends JodaWorkingWeek implements TradingWeek {
	public enum LoadType { MEMORY, FILE };
	
    private long weekMillis = -1;
    
    private List<TradingSessionImpl> sessions = new ArrayList<TradingSessionImpl>();
    ...
    static {
        ...
        DEFAULT_PROPS.put("DEFAULT_CALENDAR.holidayDateFileLoadType", TradingWeekImpl.LoadType.MEMORY);
        ...
        try {
            DEFAULT = TradingWeekImpl.configBuilder(DEFAULT_PROPS, "DEFAULT_CALENDAR", "DEFAULT_SESSIONS").build();
     ...
     * @param tradingDays
     */
    private TradingWeekImpl(byte tradingDays) {
        super(tradingDays);
    }
     ...
     *                                      contained {@link TradingSessionImpl}s.
     *                                      
    ...
    /**
     * Returns the number of {@link TradingSessionImpl}s within this {@code TradingWeek}.
     * 
     * @return  the number of {@link TradingSessionImpl}s within this {@code TradingWeek}.
     */
    @Override
	public int length() {
    ...
    /**
     * Adds a {@link TradingSessionImpl} to this {@code TradingWeek}.
     * 
     * @param session   the {@code TradingSession} to add.
     */
    @Override
    public void addTradingSession(TradingSession session) {
        sessions.add((TradingSessionImpl)session);
        weekMillis = -1;
        setWeekMillis();
    }
    
    /**
     * Returns the first {@link TradingSessionImpl} in this {@code TradingWeek}.
     * 
     * @return the first {@link TradingSessionImpl} in this {@code TradingWeek}.
     */
    @Override
    ...
    /**
     * Returns the last {@link TradingSessionImpl} in this {@code TradingWeek}.
     * 
     * @return the last {@link TradingSessionImpl} in this {@code TradingWeek}.
     */
    @Override
    ...
    /**
     * Returns a default {@link TradingWeekImpl} used for testing.
     * 
     * @return  a default {@link TradingWeekImpl}.
     */
    public static TradingWeek loadDefaultTradingWeek() {
        ...
        TradingWeekImpl tradingWeek = new TradingWeekImpl(ww.getWorkingDays());
        for(int i = 0;i < days.length;i++) {
            int day = days[i];
            tradingWeek.addTradingSession(new TradingSessionImpl(day, day,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TradingWeekImpl other = (TradingWeekImpl) obj;
        if (sessions == null) {
    ...
    private boolean equalSessions(List<TradingSessionImpl> l) {
        for(TradingSession ts : sessions) {
    ...
    public static abstract class Builder {
        int[] days;
        List<TradingSessionImpl> sessions = new ArrayList<TradingSessionImpl>();
         ...
         * in the constructed {@link TradingWeekImpl}. The supplied integers should be
        ...
        /**
         * Adds a configured session to be added to the constructed {@link TradingWeekImpl}.
         ...
         * 
         * @param beginDay      the starting day of the constructed {@link TradingWeekImpl}.
         * @param startTime     the starting time of on the start day of the session.
         * @param endDay        the ending day of the constructed {@link TradingWeekImpl}.
        ...
        public void addTradingSession(int beginDay, String startTime, int endDay, String endTime) {
            ...
            TradingSessionImpl session = new TradingSessionImpl(beginDay, endDay,
        ...
        /**
         * Builds a new immutable {@link TradingWeekImpl} using the "builder pattern" to ensure
         ...
         *                                  {@link TradingSessionImpl}s configured.
         */
        public TradingWeek build() throws IllegalStateException {
            ...
            TradingWeekImpl rawTradingWeek = createRawTradingWeek();
            for(TradingSessionImpl session : sessions) {
        ...
        /**
         * Instantiates a "raw" {@link TradingWeekImpl}, that is, a TradingWeek
         * without any holidays yet configured.
         * 
         * @return  a "raw" {@code TradingWeek}.
         */
        private TradingWeekImpl createRawTradingWeek() {
            //Load the TradingWeek
            WorkingWeek ww = new WorkingWeek();
            for(int day : days) {
                ww = ww.withWorkingDayFromCalendar(true, day);
    ...
    public static class ConfigBuilder extends Builder {
        ...
        /**
         * Returns a properly constructed {@link TradingWeekImpl}
         */
        @Override
        public TradingWeek build() throws IllegalStateException {
         ...
         * <p>
         * Each {@link TradingSessionImpl} has a statement of sessions identified with it.
