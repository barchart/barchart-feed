...
public class DefMarket extends NulMarket {
	...
	private static final Logger log = LoggerFactory.getLogger(DefMarket.class);
	...
	protected final Set<Component> changeSet = EnumSet.noneOf(Component.class);
	...
	public SessionSet sessionSet() {
		return new FrozenSessionSet(instrument, get(MarketField.BAR_CURRENT), get(MarketField.BAR_CURRENT_EXT),
				get(MarketField.BAR_PREVIOUS), get(MarketField.BAR_PREVIOUS_EXT));
	}
